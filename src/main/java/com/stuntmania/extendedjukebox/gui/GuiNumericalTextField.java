...
public class GuiNumericalTextField extends GuiTextField {
	
	public interface ICharFilter {
		
		boolean passesFilter(GuiNumericalTextField tf, char c);
	}
	
	public static final ICharFilter FILTER_NUMERIC = new ICharFilter() {
		@Override
		public boolean passesFilter(GuiNumericalTextField tf, char c) {
	...
	public GuiNumericalTextField(FontRenderer fnt, int x, int y, int width, int height) {
		this(fnt, x, y, width, height, null);
	}
	
	public GuiNumericalTextField(FontRenderer fnt, int x, int y, int width, int height, ICharFilter charFilter) {
	...
	public GuiNumericalTextField setCharFilter(ICharFilter filter) {
		this.filter = filter;
		return this;
	}
